...
namespace Test
{
    public class ListRandomTest
    {
        ...
        public void SerializeDeserializeNormal()
        {
            ...
            Assert.AreEqual(String.Empty, testListRandomNodes.Head.Data);
            ...
            Assert.AreEqual(String.Empty, testListRandomNodes.Tail.Data);
        }

        [Test]
        public void SerializeDeserializeNormalManyElements()
        {
